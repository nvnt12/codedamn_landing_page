...
const company = ['About', 'Careers', 'Support', 'Terms', 'Privacy', 'Feedback']
...
export default function Footer() {
	return (
		<div className=" bg-zinc-50 border-t border-gray-200">
					...
					<div className="w-full pr-6 sm:w-full">
						...
						<div className="flex w-full mt-8">
							{links.map((link, index) => (
								<Link key={`${link.linkName}-${index}`} href={''}>
									<link.icon />
								</Link>
							))}
						</div>
							...
							<div className="">
								...
								<ul>
									{solutions.map((solution, index) => (
										<li key={`${solution}-${index}`} className="mb-4">
											<a
							...
							<div className="mt-12 md:mt-0">
								...
								<ul>
									{resources.map((resource, index) => (
										<li key={`${resource}-${index}`} className="mb-4">
											<a
												href=""
												className="text-md font-normal text-zinc-500 hover:text-zinc-900 mb-4"
											>
...
function FacebookLogo() {
	return (
		<svg
			...
			xmlns="http://www.w3.org/2000/svg"
			viewBox="0 0 24 24"
			className="h-6 w-6 mr-4 sm:mr-6 fill-gray-500 hover:fill-gray-700"
			aria-hidden="true"
			width="24"
			height="24"
		>
		...
		>
			...
			<g id="surface1">
				<g clipPath="url(#clip1)" clipRule="nonzero">
					<path d="M 72.910156 19.132812 C 72.214844 15.34375 68.914062 12.585938 65.078125 11.722656 C 59.339844 10.519531 48.722656 9.65625 37.234375 9.65625 C 25.753906 9.65625 14.96875 10.519531 9.222656 11.722656 C 5.398438 12.585938 2.085938 15.167969 1.394531 19.132812 C 0.691406 23.4375 0 29.46875 0 37.21875 C 0 44.972656 0.691406 51 1.5625 55.308594 C 2.261719 59.09375 5.566406 61.855469 9.394531 62.714844 C 15.484375 63.921875 25.925781 64.78125 37.414062 64.78125 C 48.902344 64.78125 59.339844 63.921875 65.433594 62.714844 C 69.257812 61.855469 72.5625 59.269531 73.261719 55.308594 C 73.957031 51 74.824219 44.796875 75.003906 37.21875 C 74.648438 29.46875 73.777344 23.4375 72.910156 19.132812 Z M 27.84375 49.277344 L 27.84375 25.160156 L 49.070312 37.21875 Z M 27.84375 49.277344 "></path>
				</g>
			</g>
		</svg>
	)
