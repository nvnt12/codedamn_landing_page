		...
		<>
			...
			<section>
				<div className="relative w-full text-center pt-6 pb-6 bg-white/50 overflow-hidden">
					...
					<div className="w-fit lg:w-full flex lg:flex-col">
						<div className="flex justify-center items-center w-full my-4 lg:my-12">
							<svg
						...
						<div className="flex justify-center items-center w-full my-4 lg:my-12">
							<svg
								xmlnsXlink="http://www.w3.org/1999/xlink"
								xmlns="http://www.w3.org/2000/svg"
								className="w-[101px] lg:w-[162px] h-[35px] -mt-2 mx-4 fill-zinc-600"
								width="200"
								height="80"
							>
								<defs>
							...
							<svg
								xmlnsXlink="http://www.w3.org/1999/xlink"
								xmlns="http://www.w3.org/2000/svg"
								className="w-[100px] lg:w-[160px] h-[42px] mt-1 mx-4 fill-zinc-600"
								width="200"
								height="80"
							>
								<defs>
				...
				<div className="w-full h-fit bg-zinc-50/20 border-t border-gray-100 py-[124px] bg-gradient-to-l bg-big-grid-lines">
					<div className="w-full flex flex-col items-center">
						...
						<span className="text-xl font-normal max-w-3xl leading-8 tracking-tight text-center text-gray-600 mt-2 mb-20 px-6">
							Learn from carefully curated learning paths with up-to-date interactive
							...
							<div className="relative w-full lg:w-3/6 px-14 lg:py-16 flex flex-col items-center top-0 text-center lg:text-left">
								<div className="py-3 lg:py-6 max-w-xl flex flex-col items-center lg:items-start">
									...
									<p className="text-base font-normal leading-[26px] text-zinc-700 mt-1">
										Meet Jarvis, your personal state-of-the-art AI assistant who
										is available 24x7 to clarify your doubts, solve problems and
										help you whenever you get stuck.
									</p>
								</div>
							</div>
						</div>
					...
					<div className="w-full flex flex-col items-center">
						...
						<span className="text-xl max-w-3xl font-normal leading-8 tracking-tight text-center text-gray-600 my-2 px-6">
							Become a better programmer by building tons of real-world projects and
							...
							<div className="relative w-full flex flex-col items-center lg:w-3/6 h-full px-10 sm:px-12 pb-8 lg:px-16 lg:py-16">
								<div className="pt-6 pb-9 lg:pr-4 max-w-xl  flex flex-col items-center lg:items-start lg:text-left text-center">
									...
									<p className="text-base font-normal leading-[26px] text-zinc-700 mt-1">
										...
										projects to practice, build for your resume and showcase to
										the world.
									</p>
								</div>
								<div className="pt-6 pb-9 lg:pr-4 max-w-xl  flex flex-col items-center text-center lg:items-start lg:text-left">
									...
									<p className="text-base font-normal leading-[26px] text-zinc-700 mt-1">
										...
										better with CodeReport&trade;. Get detailed feedback on your
										projects.
									</p>
								</div>
								<div className="pt-6 pb-9 lg:pr-4 max-w-xl  flex flex-col items-center text-center lg:items-start lg:text-left">
									...
									<p className="text-base font-normal leading-[26px] text-zinc-700 mt-1">
										Use code brushes in playgrounds to fix, debug, refactor or
										even write full code blocks - at a click of a button
									</p>
								</div>
							</div>
						</div>
						<div className="relative w-full h-[440px] mb-24 overflow-clip">
							<div className="relative w-full h-full grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 md:gap-5 lg:gap-4 px-6">
								<div className="w-fit">
									<Image
								...
								<div className="w-fit hidden md:block lg:block">
									<Image
						...
						<div className="w-full h-fit flex">
							<div className="relative w-full flex flex-col items-center lg:items-start lg:w-3/6 h-full px-6 lg:pl-6 lg:pr-16 pt-16">
								<div className="pt-6 flex flex-col items-center lg:items-start pb-9 text-center lg:text-left">
									<h2 className="text-[30px] leading-9 font-bold text-gray-900 tracking-tight">
									...
									<p className="text-[18px] max-w-xl font-normal leading-[26px] text-zinc-700 mt-3">
										Transform the way you learn coding and connect with other
										like minded developers across the globe.
									</p>
								</div>
								<div className="pt-6 pb-9 pr-4 flex flex-col items-center lg:items-start text-center lg:text-start">
									...
									<p className="text-base font-normal max-w-xl leading-[26px] text-zinc-700 mt-1">
										...
										projects collaboratively, from anywhere around the globe.
									</p>
								</div>
								<div className="pt-6 pb-9 xl:pr-16 flex flex-col items-center lg:items-start text-center lg:text-start">
									...
									<p className="text-base max-w-xl font-normal leading-[26px] text-zinc-700 mt-1">
										Find developers, mentors, and new friends. Attend exclusive
										events organized by codedamn and have fun while growing your
										skills.
									</p>
								</div>
				...
				<div className="relative px-6 flex w-full max-w-screen-2xl snap-x snap-mandatory overflow-x-scroll py-20 md:block md:columns-2 lg:columns-3 bg-small-grid-lines">
						...
						<blockquote className="relative text-900">
							...
							<div className=" mt-6">
								<p className="text-gray-700 font-normal tracking-normal leading-7 mt-1.5 xl:text-lg">
									&ldquo;I have seen so many courses but finding course that gives
									lecture + playground to code is difficult to find. But codedamn
									is totally amazing in this perspective even quality of content
									is unmatchable and helped me many times in understanding
									concepts in depth.&rdquo;
								</p>
							</div>
						</blockquote>
					...
					<figure className="mx-[5vw] mb-4 flex min-w-[90vw] snap-center flex-col justify-between rounded-xl border border-gray-100 bg-white p-6 shadow-xl shadow-gray-900/10 md:mx-0 md:inline-block md:min-w-fit">
						<blockquote className="relative text-900">
							...
							<div className=" mt-6">
								<p className="text-gray-700 font-normal tracking-normal leading-7 mt-1.5 xl:text-lg">
									&ldquo;Codedamn is building a killer ecosystem. Really amazed to
									see what they have brought in the last 6 months&#129327;.&rdquo;
								</p>
							</div>
						</blockquote>
						<div className="w-full h-px bg-gray-200 my-6"></div>
						...
						<blockquote className="relative text-900">
							...
							<div className=" mt-6">
								<p className="text-gray-700 font-normal tracking-normal leading-7 mt-1.5 xl:text-lg">
									...
									extremely good! The speaker is well versed in Solidity and the
									environment that codedamn provides for learning and interaction
									is very impressive&#10024;.&rdquo;
								</p>
							</div>
						</blockquote>
						<div className="w-full h-px bg-gray-200 my-6"></div>
					...
					<figure className="mx-[5vw] mb-4 flex min-w-[90vw] snap-center flex-col justify-between rounded-xl border border-gray-100 bg-white p-6 shadow-xl shadow-gray-900/10 md:mx-0 md:inline-block md:min-w-fit">
						<blockquote className="relative text-900">
							...
							<div className=" mt-6">
								<p className="text-gray-700 font-normal tracking-normal leading-7 mt-1.5 xl:text-lg">
									&ldquo;Codedamn is a super slick platform that teaches in demand
									tech stacks. It&rsquo;s great to start with because the practice
									exercises and tasks are completed in the browser in a super cool
									IDE&#128126;.&rdquo;
								</p>
							</div>
						</blockquote>
					...
					<figure className="mx-[5vw] mb-4 flex min-w-[90vw] snap-center flex-col justify-between rounded-xl border border-gray-100 bg-white p-6 shadow-xl shadow-gray-900/10 md:mx-0 md:inline-block md:min-w-fit">
						<blockquote className="relative text-900">
							...
							<div className=" mt-6">
								<p className="text-gray-700 font-normal tracking-normal leading-7 mt-1.5 xl:text-lg">
									&ldquo;For my full-stack learning path, I chose codedamn over
									other options like Masai, Newton, etc. The subscription cost is
									bare minimum, their inbuilt IDE works great and the support is
									amazing.&rdquo;
								</p>
							</div>
						</blockquote>
					...
					<figure className="mx-[5vw] mb-4 flex min-w-[90vw] snap-center flex-col justify-between rounded-xl border border-gray-100 bg-white p-6 shadow-xl shadow-gray-900/10 md:mx-0 md:inline-block md:min-w-fit">
						<blockquote className="relative text-900">
							...
							<div className=" mt-6">
								<p className="text-gray-700 font-normal tracking-normal leading-7 mt-1.5 xl:text-lg">
									&ldquo;In my experience, codedamn is an extremely effective tool
									for learning how to code. They provide a structured curriculum
									as well as many amazing projects. I&rsquo;m becoming more
									productive and better at programming.&rdquo;
								</p>
							</div>
						</blockquote>
						<div className="w-full h-px bg-gray-200 my-6"></div>
						...
						<blockquote className="relative text-900">
							...
							<div className=" mt-6">
								<p className="text-gray-700 font-normal tracking-normal leading-7 mt-1.5 xl:text-lg">
									...
									codedamn playgrounds. I chose it because it was fast and free in
									comparison to other platforms I explored.&rdquo;
								</p>
							</div>
						</blockquote>
						<div className="w-full h-px bg-gray-200 my-6"></div>
					...
					<figure className="mx-[5vw] mb-4 flex min-w-[90vw] snap-center flex-col justify-between rounded-xl border border-gray-100 bg-white p-6 shadow-xl shadow-gray-900/10 md:mx-0 md:inline-block md:min-w-fit">
						<blockquote className="relative text-900">
							...
							<div className=" mt-6">
								<p className="text-gray-700 font-normal tracking-normal leading-7 mt-1.5 xl:text-lg">
									&ldquo;I decided to learn on codedamn and have not regretted it
									at all! They have easy to follow videos that break down every
									concept. As someone who needs a bit longer time to process
									things, I appreciated this so much.&rdquo;
								</p>
							</div>
						</blockquote>
						<div className="w-full h-px bg-gray-200 my-6"></div>
					...
					<figure className="mx-[5vw] mb-4 flex min-w-[90vw] snap-center flex-col justify-between rounded-xl border border-gray-100 bg-white p-6 shadow-xl shadow-gray-900/10 md:mx-0 md:inline-block md:min-w-fit">
						<blockquote className="relative text-900">
							...
							<div className=" mt-6">
								<p className="text-gray-700 font-normal tracking-normal leading-7 mt-1.5 xl:text-lg">
									&ldquo;Codedamn has many roadmaps you can explore to learn how
									to code and build skills as a dev. It’s very well structured and
									the Pro version is pretty affordable as well, giving you
									unlimited access to all the features.&rdquo;
								</p>
							</div>
						</blockquote>
						<div className="w-full h-px bg-gray-200 my-6"></div>
					...
					<figure className="mx-[5vw] mb-4 flex min-w-[90vw] snap-center flex-col justify-between rounded-xl border border-gray-100 bg-white p-6 shadow-xl shadow-gray-900/10 md:mx-0 md:inline-block md:min-w-fit">
						<blockquote className="relative text-900">
							...
							<div className=" mt-6">
								<p className="text-gray-700 font-normal tracking-normal leading-7 mt-1.5 xl:text-lg">
									&ldquo;I feel codedamn has high potential and they provide free
									learning material. Mehul has done a great job by founding such a
									good platform.&rdquo;
								</p>
							</div>
						</blockquote>
					...
					<figure className="mx-[5vw] mb-4 flex min-w-[90vw] snap-center flex-col justify-between rounded-xl border border-gray-100 bg-white p-6 shadow-xl shadow-gray-900/10 md:mx-0 md:inline-block md:min-w-fit">
						<blockquote className="relative text-900">
							...
							<div className=" mt-6">
								<p className="text-gray-700 font-normal tracking-normal leading-7 mt-1.5 xl:text-lg">
									&ldquo;Courses on codedamn are really beginner-friendly and the
									exercises are great for practicing as you learn..&rdquo;
								</p>
							</div>
						</blockquote>
						<div className="w-full h-px bg-gray-200 my-6"></div>
						...
						<div className="order-1 flex h-full items-center justify-center lg:order-2 lg:pr-4 lg:pt-4">
							<div className="relative mx-auto max-w-2xl text-center lg:mx-0 lg:max-w-lg lg:text-left">
								...
								<p className="text-lg leading-8 my-6 text-gray-600">
									Codedamn&apos;s mobile app keeps you connected to your progress
									and enables learning programming on-the-go from anywhere around
									the globe.
								</p>
